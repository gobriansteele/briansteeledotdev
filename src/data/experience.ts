export const experience = [
  ...
  } as const,
  {
    ...
    tags: ['TypeScript', 'React', 'Leadership'],
    description: `Led migration from Flow to TypeScript. Led integration of new HR software into website to automate job postings. Worked with product/creative to implement custom CMS for company blog.`,
  } as const,
  {
    startDate: '2013',
    endDate: '2019',
